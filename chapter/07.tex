...
\begin{align*}
    f(a+0\delta) \,dx + f(a+1\delta) \,dx + \dots + f(a+(\infty-2)\delta) \,dx + f(a+(\infty-1)\delta) \,dx &= F(a+\delta)-F(a) + F(a+2\delta)-F(a+\delta) + F(a+3\delta)-F(a+2\delta) + \cdots + F(b-\delta)-F(b-2\delta) + F(b)-F(b-\delta) \\
    f(a+0\delta) \,dx + f(a+1\delta) \,dx + \dots + f(a+(\infty-2)\delta) \,dx + f(a+(\infty-1)\delta) \,dx &= F(b) - F(a) \\
...
\begin{align}
    A = \sum_{n=0}^{\infty - 1}f(a+n\delta) \,dx = F(b) - F(a)
\end{align}
...
\begin{align}
    \int_a^b f(x) \,dx = \sum_{n=0}^{\infty - 1}f(a+n\delta) \,dx = F(b) - F(a) = F(x) \Bigg|_{x=a}^{x=b}
\end{align}
