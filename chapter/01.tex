...
\begin{definition}{无穷大和无穷小}
    ...
    （2）对于任意实数 C，正数 n，$\infty^{n+1} + C\infty^n = \infty^{n+1}, \varepsilon^n + C\varepsilon^{n+1} = \varepsilon^n$。

    （3） $\varepsilon$ 是最小的正数，$-\varepsilon$ 是最大的负数，$\varepsilon = 0^+, -\varepsilon = 0^-$。

    （4）对于 $n > 1$ 有，$\log_n\infty < \sqrt[n]{\infty} < \infty < \infty^n < n^\infty < \infty!$。
\end{definition}
