...
\begin{example} 计算积分 $\int \tan x \,dx$。
    ...
    \begin{align*}
        ...
        &= \int \frac{1}{\cos x} \,d(-\cosx) = -\int \frac{1}{\cos x} \,d\cosx
    \end{align*}

    对照链式法则公式：
    \begin{align*}
        &u' = \frac{1}{x} \quad u = \ln x \quad v = \cos x \\
        &\implies u'(v) = \frac{1}{\cos x} \quad u(v) = \ln(\cosx)
    \end{align*}
    所以 $$\int \tan x \,dx = -\int \frac{1}{\cos x} \,d\cosx = -\int \,d\ln |\cos x| = -ln |\cos x| + C$$
\end{example}
